...
const char *fragmentShader1Source1 = 
    "#version 330 core\n"
    "out vec4 FragColor;\n"
    "void main()\n"
    "{\n"
...
const char *fragmentShader1Source2 = 
    "#version 330 core\n"
    "out vec4 FragColor;\n"
    "void main()\n"
    "{\n"
...
int main()
{
    ...
    glShaderSource(fragmentShader1, 1, &fragmentShader1Source1, NULL);
    ...
    // 检测是否链接成功
    glGetProgramiv(shaderProgram1, GL_LINK_STATUS, &success);    // 与shader的不同
    if (!success) {
    ...
    glShaderSource(fragmentShader2, 1, &fragmentShader1Source2, NULL);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glBindVertexArray(VAOs[0]); // 绑定顶点数组
        glDrawArrays(GL_TRIANGLES, 0, 3);

        glUseProgram(shaderProgram2);
        glBindVertexArray(VAOs[1]); // 绑定顶点数组
        glDrawArrays(GL_TRIANGLES, 0, 3);
